...
set "NO_FMA=conv1d_causal gated_delta_net_scan elementwise_f32 turboquant mamba2_selective_scan mamba3_data_rope_f32 mamba3_chunk_boundary_f32 mamba3_ssd_scan_siso_f32 mamba3_ssd_scan_mimo_f32"
