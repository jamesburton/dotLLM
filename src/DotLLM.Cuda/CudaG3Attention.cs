...
internal sealed class CudaG3Attention : IDisposable
{
    ...
    /// <c>DOTLLM_CUDA_G3_ATTN</c> overrides it ("1" force on, "0" force off). Mirrors the
    /// G1 <see cref="CudaGemm.ConfigureDefault"/> gating: on for GeForce Ampere (the parts
    /// that throttle FP32-accumulate CUDA-core attention), off elsewhere.
    /// </summary>
