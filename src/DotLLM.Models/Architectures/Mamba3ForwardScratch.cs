...
/// used by <see cref="Mamba3Block"/>'s <c>Forward</c> and <c>ForwardMimo</c>
/// methods. Mirrors the <c>NemotronHForwardState</c> pattern: one owned
/// instance per model, grown in power-of-two steps by
/// <see cref="EnsureCapacity"/>, freed on <see cref="Dispose"/>.
/// </summary>
/// <remarks>
/// <para>
