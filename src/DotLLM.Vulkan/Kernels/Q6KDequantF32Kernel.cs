...
public sealed class Q6KDequantF32Kernel : VulkanComputeKernelBase
{
    ...
    private Q6KDequantF32Kernel(VulkanDevice device, string spvDir)
        : base(device, spvDir, "q6_k_dequant_f32.spv", buffersPerSet: 2, pushConstantBytes: PushConstantBytes)
    {
    }

    /// <summary>Loads <c>q6_k_dequant_f32.spv</c> from the given directory and creates the pipeline.</summary>
    public static Q6KDequantF32Kernel Create(VulkanDevice device, string spvDir) => new(device, spvDir);
