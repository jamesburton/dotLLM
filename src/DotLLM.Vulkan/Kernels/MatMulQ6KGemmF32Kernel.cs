...
/// <remarks>
/// <para>
/// Companion to <see cref="MatMulQ6KGemvF32Kernel"/> (decode-path GEMV).
/// Tiling: 16x16 output tile per workgroup, K-chunk = 32 elements, 8 K-chunks
/// per super-block — same shape as the Q4_K / Q5_K GEMM siblings landing in
/// parallel extraction PRs. Q6_K's dequant is structurally simpler than
/// Q4_K / Q5_K — scale-only reconstruction with 16 signed <c>int8</c> scales
/// and signed quants in <c>-32..31</c>. See
/// <see cref="MatMulQ6KGemvF32Kernel"/> for the full byte-extraction
/// commentary.
/// </para>
/// <para>
