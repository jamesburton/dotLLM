...
dense YaRN RoPE, and biased MXFP4 MoE experts all simultaneously active,
compared against the CPU oracle through `CudaModelLoader.CreateFromGguf`
itself. Observed max |diff| on last-token logits: 1.550E-003 against a
tolerance of 8.0E-003, on a real RTX 3060 (2026-09-02). A companion test
measures each feature's individual effect on the logits (7.2E-002 to 5.6E-001)
to prove the tolerance is tight enough to catch any one of them being dropped.
